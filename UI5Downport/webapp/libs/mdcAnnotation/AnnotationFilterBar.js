sap.ui.define([
	...
	"mdcAnnotation/FieldFactory"
], function (FilterBar, FilterBarBaseRenderer, Condition, ConditionValidated, Resolver, FieldFactory) {
	"use strict";

	var AnnotationFilterBar = FilterBar.extend("mdcAnnotation.AnnotationFilterBar", {
		metadata: {
			properties: {
	...
	AnnotationFilterBar.prototype.init = function () {
		...
		this.setDelegate({ name: "mdcAnnotation/delegate/FilterBarDelegate", payload: {} });
